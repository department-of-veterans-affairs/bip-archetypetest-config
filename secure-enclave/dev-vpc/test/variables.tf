...
locals {
  ...
  vpc_id = data.terraform_remote_state.fti-dvpc.outputs.dvpc_id_out

  cluster_id = data.terraform_remote_state.fti-dvpc.outputs.dvpc_cluster_id_out
  cluster_name = data.terraform_remote_state.fti-dvpc.outputs.dvpc_cluster_name_out
  listener_arn = data.terraform_remote_state.fti-dvpc.outputs.dvpc_alb_listener_arn_out
...
variable "secure_enclave_container_role_arn" {
  ...
  default = "arn:aws-us-gov:iam::999999999999:role/project/project-test-bip-archetypetest-container-role"
}